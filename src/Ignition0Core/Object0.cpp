...
void 		Object0::setOnUpdate(std::function<void(Object0&)> func) { onUpdate = func; 								}
void 		Object0::setProjection(glm::mat4 projection) 			 { Projection = projection;							}
void 		Object0::setMaterial(m<Material> mat) 					 { material = mat?mat:internal::Ignition0.missing; 	}
m<Material> Object0::getMaterial()  						  		 { return material;   								}
...
void Object0::update(glm::mat4 projection) {
	...
	setProjection(projection * getTransformation());
	update();
}
